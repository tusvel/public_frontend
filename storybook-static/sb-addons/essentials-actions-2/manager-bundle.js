try {
  ...
  var Yn = __STORYBOOKCOREEVENTS__,
    {
      ...
      SHARED_STATE_CHANGED: ya,
      SHARED_STATE_SET: Oa,
      STORIES_COLLAPSE_ALL: va,
      STORIES_EXPAND_ALL: Ta,
      STORY_ARGS_UPDATED: _a,
      STORY_CHANGED: U,
      STORY_ERRORED: Ra,
      STORY_INDEX_INVALIDATED: Aa,
      STORY_MISSING: Sa,
      STORY_PREPARED: Ca,
      STORY_RENDERED: xa,
      STORY_RENDER_PHASE_CHANGED: wa,
      STORY_SPECIFIED: Na,
      STORY_THREW_EXCEPTION: La,
      STORY_UNCHANGED: Ia,
      TOGGLE_WHATS_NEW_NOTIFICATIONS: Da,
      UPDATE_GLOBALS: Ma,
  ...
  var ie = ({ data: e }) => {
      ...
      if (Array.isArray(r)) {
        ...
        return a.createElement(
          ...
          a.createElement('span', { style: t.preview }, '[', He(o, ', '), ']'),
        );
      } else {
    ...
    Rt = ({ name: e, data: t }) =>
      typeof e == 'string'
        ...
        : a.createElement(ie, { data: t }),
    At = ({ name: e, data: t, isNonenumerable: r = !1 }) => {
      let n = t;
      return a.createElement(
        'span',
        null,
    ...
    Ct = ({ depth: e, name: t, data: r, isNonenumerable: n }) =>
      e === 0
        ...
        : a.createElement(At, { name: t, data: r, isNonenumerable: n }),
    xt = ({
  ...
  var Lt = ({ rows: e, columns: t, rowsData: r }) => {
    ...
    kt = (e) =>
      a.createElement($e, { nodeRenderer: jt, dataIterator: Ut, ...e }),
    Gt = ue(kt),
    Wt = dt(gt()),
  ...
  var jo = __STORYBOOKCOMPONENTS__,
    {
      A: Uo,
      ActionBar: Xe,
      AddonPanel: ko,
  ...
  function V(e) {
    ...
    return (
      (V = function (n) {
        ...
        function o() {
          return D(n, arguments, W(this).constructor);
        }
        return (
  ...
  function ir(e, t, r, n) {
    if (
      ...
      return n >= 1 ? ee(e, t, r) : 'rgba(' + $(e, t, r) + ',' + n + ')';
  ...
  var Sr = k.div({
    ...
    Mr = class extends we {
      ...
      componentDidMount() {
        ...
        e.on(H, this.addAction), e.on(U, this.handleStoryChange);
      }
      componentWillUnmount() {
        this.mounted = !1;
        let { api: e } = this.props;
        e.off(U, this.handleStoryChange), e.off(H, this.addAction);
      }
      render() {
