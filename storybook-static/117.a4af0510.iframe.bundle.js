(self.webpackChunkpublic_frontend =
  ...
  [117],
  {
    './node_modules/react-i18next/dist/es/index.js': (
      ...
      __webpack_require__('./node_modules/void-elements/index.js');
      Object.create(null);
      const alreadyWarned = {};
      function utils_warnOnce() {
        ...
        ('string' == typeof args[0] && alreadyWarned[args[0]]) ||
          ('string' == typeof args[0] && (alreadyWarned[args[0]] = new Date()),
          (function utils_warn() {
      ...
      function loadLanguages(i18n, lng, ns, cb) {
        'string' == typeof ns && (ns = [ns]),
          ns.forEach((n) => {
            i18n.options.ns.indexOf(n) < 0 && i18n.options.ns.push(n);
          }),
      ...
      class ReportNamespaces {
        ...
        addUsedNamespaces(namespaces) {
          namespaces.forEach((ns) => {
            this.usedNamespaces[ns] || (this.usedNamespaces[ns] = !0);
          });
        }
        getUsedNamespaces() {
      ...
      function useTranslation_useTranslation(ns) {
        ...
        const { i18n: i18nFromProps } = props,
          { i18n: i18nFromContext, defaultNS: defaultNSFromContext } =
        ...
        if (
          ...
          const notReadyT = (k, optsOrDefaultValue) =>
              'string' == typeof optsOrDefaultValue
                ? optsOrDefaultValue
                : optsOrDefaultValue &&
                  'object' == typeof optsOrDefaultValue &&
                  'string' == typeof optsOrDefaultValue.defaultValue
        ...
        const i18nOptions = {
          ...
          { useSuspense, keyPrefix } = i18nOptions;
        let namespaces =
          ns ||
          defaultNSFromContext ||
          (i18n.options && i18n.options.defaultNS);
        (namespaces =
          'string' == typeof namespaces
            ? [namespaces]
            : namespaces || ['translation']),
          i18n.reportNamespaces.addUsedNamespaces &&
            ...
            (function hasLoadedNamespace(ns, i18n) {
              let options =
                arguments.length > 2 && void 0 !== arguments[2]
                  ? arguments[2]
                  : {};
              return i18n.languages && i18n.languages.length
                ? void 0 !== i18n.options.ignoreJSONStructure
                  ...
                  : (function oldI18nextHasLoadedNamespace(ns, i18n) {
                      ...
                      const loadNotPending = (l, n) => {
                        const loadState =
                          i18n.services.backendConnector.state[`${l}|${n}`];
                      ...
                      return !(
                        ...
                        (!i18n.hasResourceBundle(lng, ns) &&
                          ...
                          (!i18n.options.resources ||
                            i18n.options.partialBundledLanguages) &&
        ...
        const isInitial = (0, react.useRef)(!0);
        (0, react.useEffect)(() => {
          isMounted.current && !isInitial.current && setT(getT),
            (isInitial.current = !1);
        }, [i18n, keyPrefix]);
        const ret = [t, i18n, ready];
        if (((ret.t = t), (ret.i18n = i18n), (ret.ready = ready), ready))
          return ret;
    ...
    './node_modules/void-elements/index.js': (module) => {
      module.exports = {
        area: !0,
        base: !0,
        br: !0,
